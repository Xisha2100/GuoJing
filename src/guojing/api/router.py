...
from guojing.api.help_request_review import router as help_request_review_router
from guojing.api.help_requests import router as help_requests_router
...
api_router.include_router(help_request_review_router)
